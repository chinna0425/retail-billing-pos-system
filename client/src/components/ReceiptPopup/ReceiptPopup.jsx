...
const ReceiptPopup = ({ orderDetails, onClose, onPrint }) => {
	return (
		<div className="receipt-popup-overlay text-dark receipt-print">
			<div className="receipt-popup">
				...
				<div className="d-flex justify-content-end gap-3 mt-4">
					<button className="btn btn-warning no-print" onClick={onPrint}>
						Print Receipt
					</button>
					<button className="btn btn-danger no-print" onClick={onClose}>
						Close
					</button>
				</div>
			</div>
